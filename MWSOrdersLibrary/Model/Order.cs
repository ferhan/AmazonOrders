...
namespace MarketplaceWebServiceOrders.Model
{
    ...
    public class Order : AbstractMwsObject
    {
        ...
        private PaymentExecutionDetailItemList _paymentExecutionDetail;
        ...
        {
            get { return this._purchaseDate.GetValueOrDefault(DefaultDate); }
        ...
        {
            get { return this._lastUpdateDate.GetValueOrDefault(DefaultDate); }
        ...
        {
            get { return this._paymentExecutionDetail; }
        ...
        {
            return this._paymentExecutionDetail != null;
        }
        ...
        {
            get { return this._earliestShipDate.GetValueOrDefault(DefaultDate); }
        ...
        {
            get { return this._latestShipDate.GetValueOrDefault(DefaultDate); }
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "EarliestDeliveryDate")]
        public DateTime? EarliestDeliveryDate
        {
            get { return this._earliestDeliveryDate.GetValueOrDefault(DefaultDate);}
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "LatestDeliveryDate")]
        public DateTime? LatestDeliveryDate
        {
            get { return this._latestDeliveryDate.GetValueOrDefault(DefaultDate); }
        ...
        public override void WriteFragmentTo(IMwsWriter writer)
        {
            ...
            writer.Write("PaymentExecutionDetail", _paymentExecutionDetail);
        ...
        {
            writer.Write("https://mws.amazonservices.com/Orders/2011-01-01", "Order", this);
        }
