...
namespace MarketplaceWebServiceOrders.Model
{
    ...
    public class MarketplaceIdList : AbstractMwsObject
    {
        ...
        public MarketplaceIdList WithId(string[] id)
        {
        ...
        {
            writer.Write("https://mws.amazonservices.com/Orders/2011-01-01", "MarketplaceIdList", this);
        }

        public MarketplaceIdList() : base()
        {
        }
    }
}
