...
namespace MarketplaceWebServiceOrders.Model
{
    ...
    public class GetOrderRequest : AbstractMwsObject
    {
        ...
        private OrderIdList _amazonOrderId;
        ...
        public override void ReadFragmentFrom(IMwsReader reader)
        {
            ...
            _amazonOrderId = reader.Read<OrderIdList>("AmazonOrderId");
        }
        ...
        {
            writer.Write("https://mws.amazonservices.com/Orders/2011-01-01", "GetOrderRequest", this);
        }
