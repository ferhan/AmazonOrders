...
namespace MarketplaceWebServiceOrders
{
    ...
    public class MarketplaceWebServiceOrdersConfig {
        ...
        private const string DEFAULT_SERVICE_PATH = "Orders/2011-01-01";
        private const string SERVICE_VERSION = "2011-01-01";
        ...
        /// May include the path to make MWS calls to. Defaults to Orders/2011-01-01
        /// </summary>
