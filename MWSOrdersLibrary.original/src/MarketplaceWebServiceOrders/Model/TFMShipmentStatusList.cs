...
namespace MarketplaceWebServiceOrders.Model
{
    ...
    public class TFMShipmentStatusList : AbstractMwsObject
    {
        ...
        public TFMShipmentStatusList WithStatus(string[] status)
        {
        ...
        {
            writer.Write("https://mws.amazonservices.com/Orders/2011-01-01", "TFMShipmentStatusList", this);
        }

        public TFMShipmentStatusList() : base()
        {
        }
    }
}
